...
=item L<Test::BinaryData> 0.007 or greater.
...
Responds to management records. Capable of multiplexing serveral requests over one connection.

=item L<FCGI::Client>

Web server (client) implementation. Supports Responder role.
