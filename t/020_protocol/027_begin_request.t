...

{
...

    {
        ...
        is_binary($got, $exp, q<build_begin_request(1, FCGI_PARAMS, 0, {})>);
    }
...

    {
        ...
        is_binary($got, $exp, q<build_begin_request(1, FCGI_PARAMS, 0, {}, undef)>);
    }
...

{
...

    {
        ...
        is_binary($got, $exp, q!build_begin_request(1, FCGI_PARAMS, 0, { Foo => 'Bar' })!);
    }
              ...
              . "\x01\x05\x00\x01\x00\x00\x00\x00";
    {
        ...
        is_binary($got, $exp, q!build_begin_request(1, FCGI_PARAMS, 0, { Foo => 'Bar' }, 'x' x 1020)!);
    }
...

    {
        ...
        is_binary($got, $exp, q!build_begin_request(1, FCGI_PARAMS, 0, { Foo => 'Bar' }, 'x' x 1020, 'y' x 1024)!);
    }
}
